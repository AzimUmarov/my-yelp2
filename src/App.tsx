...
import {  Nav, Navbar as NavbarBS, Button, Col, Container, Form, Row, Table } from 'react-bootstrap';
...
const App: React.FC = () => {
  ...
  return (
    <Authenticator className="d-flex justify-content-center vh-100 bg-primary align-items-center">
        {({signOut}) => (
    <div className="App">
      <NavbarBS sticky="top" className="bg-dark text-white-50 shadow-sm mb-3">
      <Container >                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
          <Nav className="me-auto ">
            <Button style={{width: "3rem", height: "3rem", position: "relative"}} className="btn btn-primary w-25 " onClick={signOut}> Sign out</Button>
          </Nav>
      </Container>
      </NavbarBS>
      <Container>
